"""
Django settings for jsonbee project.
...
WSGI_APPLICATION = 'jsonbee.wsgi.application'
...
DATA_UPLOAD_MAX_NUMBER_FIELDS = config('DATA_UPLOAD_MAX_NUMBER_FIELDS', cast=int) or 5000 # bulk delete
